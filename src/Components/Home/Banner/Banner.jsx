...
const Banner = () => {
     return (
          <div className="carousel w-full md:max-h-[600px] rounded-md">
  <div id="slide1" className="carousel-item  relative w-full rounded-md">
    ...
    {/* text section */}
    <div className="w-[98%] md:max-w-sm space-y-2 md:space-y-4 text-white absolute transform -translate-y-1/2 left-2 md:left-5 right-[60%] md:right-5 top-[40%] md:top-1/2 ">
...
<p>Savor delectable dishes, an array of flavors, and exceptional dining experiences at our restaurant. Explore our menu today!</p>
    <div>
    <Link to={'/allFoods'}><button className="btn btn-outline text-white">See All Food</button></Link>
    </div>
    </div>
    {/* btn  */}
